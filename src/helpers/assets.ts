 ...
 * @example
 * ```typescript
 * // Widget built from web/widgets/flight-map.html outputs to:
 * // web/dist/widgets/flight-map.html
 * // wrangler.jsonc assets.directory = "./web/dist/widgets"
 * const html = await loadHtml(env.ASSETS, "/flight-map.html");
 * ```
 */
...
export interface WidgetConfig {
  ...
  resourceUri: string;
  /** Path to built HTML in assets (e.g., "/flight-map.html") */
  htmlPath: string;
